...
const toggleSlider = document.querySelector('.toogle-slider');
...
const pricingCardsContainerSubscription = document.getElementById('pricing-cards-subscribtion');
const pricingCardsContainerPayAsYouGo = document.getElementById('pricing-cards-payAsYouGo');
...
function setupTabsListeners() {
    tabButtons.forEach(button => {
        button.addEventListener('click', () => {
            ...
            // Simple approach: Hide toggle-slider if testing-credits tab is active
            if (tabId === 'testing-credits') {
                toggleSlider.style.display = 'none';
            } else {
                toggleSlider.style.display = '';
            }
        });
    });
}
...
function renderPricingCards() {
    const containers = [
        { container: pricingCardsContainerSubscription, plans: pricingData.plansSubscription },
        { container: pricingCardsContainerPayAsYouGo, plans: pricingData.plansPayAsYouGo }
    ];
    containers.forEach(({ container, plans }) => {
        container.innerHTML = '';
