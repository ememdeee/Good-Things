            ...
            <div class="max-w-6xl bg-[#0a1a1f] p-8 rounded-lg text-white mx-auto">
                <div class="grid md:grid-cols-2 gap-8 items-center">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="block md:hidden space-y-4 py-4">
                            <input 
                                type="text" 
                            ...
                            <div class="relative">
                                <div class="absolute left-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
                                    <img src="https://flagcdn.com/w20/us.png" alt="US flag" class="w-5">
                                    <i data-lucide="chevron-down" class="w-4 h-4 text-gray-400"></i>
                                </div>
                                <input 
                                    type="tel" 
                                    placeholder="Your phone number" 
                                    class="w-full p-3 pl-16 rounded bg-[#1a2a30] border border-gray-700 focus:outline-none focus:border-[#ffd700]"
                                >
                            </div>
                            <div class="flex flex-wrap items-center gap-4 pt-2">
                                <button class="px-2 py-2 sm:px-4 sm:py-3 bg-[#ffd700] text-black font-semibold rounded hover:bg-[#e6c200] transition-colors">
                                    Get Your Build Sheet
                                </button>
                                <button class="px-2 py-2 sm:px-6 sm:py-3 text-white font-semibold rounded flex items-center gap-2 hover:bg-[#1a2a30] transition-colors">
                                    View Sample
                    ...
                    <div class="hidden md:block space-y-4">
                        ...
                        <div class="flex flex-wrap flex-row md:flex-row items-center gap-4 pt-2">
                            <button class="px-6 py-3 bg-[#ffd700] text-black font-semibold rounded hover:bg-[#e6c200] transition-colors">
                                Get Your Build Sheet
                            </button>
                            <button class="px-6 py-3 text-white font-semibold rounded flex items-center gap-2 hover:bg-[#1a2a30] transition-colors">
                                View Sample
                                <i data-lucide="arrow-right" class="w-4 h-4"></i>
                            </button>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                type="tel" 
                                placeholder="Your phone number" 
                                class="w-full p-3 pl-16 rounded bg-[#222] text-white border border-gray-700 focus:outline-none focus:border-yellow-500"
                            >
                        </div>
                        <div class="flex flex-col sm:flex-row items-center gap-4">
                            <button class="w-full sm:w-auto px-6 py-3 bg-[#ffd700] text-black font-semibold rounded hover:bg-[#e6c200] transition-colors">
                                Get Your Report
                            </button>
