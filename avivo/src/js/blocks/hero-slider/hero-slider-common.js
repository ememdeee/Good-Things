 ...
 *
 * The `initializeHeroSlider()` function is specifically designed to initialize Splide sliders. It ensures that only
 ...
 *
 * Usage:
 * - Call the `initializeHeroSlider()` function to initialize all Splide sliders that haven't been initialized yet.
...
function initializeHeroSlider() {
	...
	document.querySelectorAll('.cdb-hero_slider .splide').forEach(function (obj) {
