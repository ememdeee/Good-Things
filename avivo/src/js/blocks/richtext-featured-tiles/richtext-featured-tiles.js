 ...
 * at the top of this file. This ensures that the `initializeSpyScroll()` function is available within this script.
 *
 * Key Elements:
 ...
 * - `initializeSpyScroll()`: This function, imported from "richtext-featured-tiles-common.js", handles the initialization 
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Call initializeSpyScroll() right after DOM is loaded
    initializeSpyScroll();
